...
parser.add_argument('--oldEtaGrid', action='store_true',
    dest='doOldEtaGrid', required = False,
    help = "Use the old grid implemented during 2017 to ringer v6 (20 phase spaces). default is 25 bins")

parser.add_argument('--newEtGrid', action='store_true',
    dest='doNewEtGrid', required = False,
    help = "Use the new grid implemented to treat boosted to ringe  (30 phase spaces). default is 25 bins")
...
if args.doJpsi:
    ...
    if args.doNewEtGrid:
        etbins  = [15.0, 20.0, 30.0, 40.0, 50.0, 140, 1000000.0]
    else:
